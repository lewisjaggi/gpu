...
int mainImage(Settings& settings)
    ...
    Viewer<ConvolutionProvider> imageVideo(nozoomable, 25, 25); // imageOption px py
//    Viewer < AmplificationProvider > imageVideo(nozoomable, 25, 25); // imageOption px py
//    Viewer < AmplificationProvider2 > imageVideo2(nozoomable, 25, 25); // imageOption px py
